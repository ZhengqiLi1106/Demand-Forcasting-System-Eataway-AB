...
Eataway 天气数据获取脚本
==============================================================================
获取历史天气 (Open-Meteo) + 未来预报 (SMHI / Open-Meteo)

用法:  pip install requests pandas && python eataway_weather.py
输出:  weather_weekly.csv (训练用) + weather_forecast.csv (预测用)
需要联网!
==============================================================================
"""
...
def fetch_history(city, lat, lon, start, end):
    """Open-Meteo 历史天气 (ERA5 再分析, 免费无key)"""
...
def main():
    print("╔" + "═" * 55 + "╗")
    print("║" + "  Eataway 天气数据获取".center(47) + "║")
    print("╚" + "═" * 55 + "╝\n")
